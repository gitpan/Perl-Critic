##############################################################################
#      $URL: http://perlcritic.tigris.org/svn/perlcritic/branches/Perl-Critic-PPI-1.204/lib/Perl/Critic/Policy/Miscellanea/RequireRcsKeywords.pm $
...
define the C<$VERSION> variable like this:
    ...
    our ($VERSION) = '$Revision: 3482 $' =~ m{ \$Revision: \s+ (\S+) }x;
