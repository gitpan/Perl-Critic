##############################################################################
#      $URL: http://perlcritic.tigris.org/svn/perlcritic/tags/Perl-Critic-1.105_03/lib/Perl/Critic/Policy/Modules/RequireVersionVar.pm $
...
A common practice is to use the C<$Revision: 3794 $> keyword to
automatically define the C<$VERSION> variable like this:

    our ($VERSION) = '$Revision: 3794 $' =~ m{ \$Revision: \s+ (\S+) }x;
