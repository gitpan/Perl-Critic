##############################################################################
#      $URL: http://perlcritic.tigris.org/svn/perlcritic/tags/Perl-Critic-1.091/lib/Perl/Critic/Policy/Modules/RequireVersionVar.pm $
...
A common practice is to use the C<$Revision: 2715 $> keyword to
automatically define the C<$VERSION> variable like this:

    our ($VERSION) = '$Revision: 2715 $' =~ m{ \$Revision: \s+ (\S+) }x;
